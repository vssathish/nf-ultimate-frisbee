    ...
    return (
      <div className="App">
        <header className="header">
            ...
            <p className="next-game">
               Block the time on your calendar! <a target="_blank" rel="noopener noreferrer" href="https://calendar.google.com/event?action=TEMPLATE&amp;tmeid=MDQ4b2tqZHRsZGIyYmdmNGk4YTI3czhxdTdfMjAyMTA5MDFUMTkwMDAwWiBkYXJyeWwubGVlQG0&amp;tmsrc=darryl.lee%40gmail.com&amp;scp=ALL">Wed</a> | <a target="_blank" rel="noopener noreferrer" href="https://calendar.google.com/event?action=TEMPLATE&amp;tmeid=MDYyc3NtazB0Y3Rsa3VkbjRrNHZyOXNqYTBfMjAyMTA5MDNUMTkwMDAwWiBkYXJyeWwubGVlQG0&amp;tmsrc=darryl.lee%40gmail.com&amp;scp=ALL">Fri</a>
               <br />
            ...
            <p className="next-game">
              IF YOU DON'T SEE TIME/PLACE ABOVE, PLEASE ADD YOUR NAME AND CLICK SIGN-UP TO SEE PLAYERS! SITE IS SLIGHTLY BROKEN, SORRY.
            </p>
        </header>
